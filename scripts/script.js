...
const inputProfilePopupName = document.querySelector(".profile-popup__form_input_name");
const inputProfilePopupSubname = document.querySelector(".profile-popup__form_input_subname");
...
const cardProfileInputName = document.querySelector(".card-popup__form_input_name");
const cardProfileInputLink = document.querySelector(".card-popup__form_input_link");
